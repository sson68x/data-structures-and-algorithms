...
const addPurchases = (arr) => {
  let total = arr.reduce((accumulator, currentValue) =>
    accumulator = accumulator + currentValue.purchasePrice, 0);
  return total;
};
...
const countNumberOfElements = (arr) => {
  let total = arr.reduce((accumulator) => accumulator = accumulator + 1, 0);
  return total;
};
...
const reversedString = (str) => {
  ...
  let reversedStr = newArr.reduce((accumulator, currentValue) => {
