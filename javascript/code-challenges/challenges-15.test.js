...
let biggerThanLuke = (arr) => {
  return arr.filter(char => char.mass > parseInt(arr[0].mass)).map(char => char.name).join(' - ');
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const detectTicTacToeWin = (board) => {
  ...
  if (checker(board[0][0], board[0][1], board[0][2])) {
    return true;
  }
  if (checker(board[1][0], board[1][1], board[1][2])) {
    return true;
  }
  if (checker(board[2][0], board[2][1], board[2][2])) {
    return true;
  }
  if (checker(board[0][0], board[1][0], board[2][0])) {
    return true;
  }
  if (checker(board[0][1], board[1][1], board[2][1])) {
    return true;
  }
  if (checker(board[0][2], board[1][2], board[2][2])) {
    return true;
  }
  if (checker(board[0][0], board[1][1], board[2][2])) {
    return true;
  }
  if (checker(board[0][2], board[1][1], board[2][0])) {
    return true;
  }
  return false;
};
